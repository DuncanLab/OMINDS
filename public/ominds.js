...
function ominds(
  ...
  function create2DArray(len){
    ...
    // STEP 1: DIFFERENCE SCORES
      ...
      switch (true) {
        ...
        case memorability != "n" && nameability != "n" && emotionality != "n":
          // all three
          console.log("All three axis selected")
          // console.log(helpers.eucDistance())
          records.forEach(function (record) {
            // console.log(record)
            record["dist"] = helpers.eucDistance(
            ...
            dist_array.push(helpers.eucDistance(
              [memorability, nameability, emotionality],
              [
                record["scaled_memory_hits"],
                record["scaled_name"],
  ...
  async function step_eight(){
    ...
    // console.log(dist_array.reduce((a, b) => a + b, 0))
    // console.log(dist_array.reduce((a, b) => a + b) / dist_array.length)
  }
